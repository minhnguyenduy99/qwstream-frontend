    ...
    <b-navbar fixed-top type="is-primary">
      ...
      <template slot="start">
        ...
        <b-navbar-item
          tag="div"
          :active="false"
          class="py-0 search-area is-flex is-align-items-center is-justify-content-space-between"
        >
          <b-field class="mb-0" style="width: 400px">
            <b-input
...
import { QwBadge } from "@/components";
...
export default {
  ...
  watch: {
    selectedCategoryIndex: function(newVal, oldVal) {
      let category = this.categoryOptions[newVal];
    }
  },
  computed: {
  ...
  methods: {
    openChannelSidebar() {
      this.$emit("open-channel-sidebar");
    }
  }
};
</script>
